...
```{r tidy}
# in general, I would consider keeping the comments within the code chunks shorter, with more explication outside of the code chunks (example here and above). 
